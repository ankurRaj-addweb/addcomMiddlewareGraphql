...
```sh
grep -rl 'addcom' ./ | xargs sed -i '' 's/addcom/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with addcom
...
Want to contribute? Ping us on `addcom` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/addcom.git
    cd addcom
    ```
...
- [addcom integration Documentation](https://docs.vuestorefront.io/addcom)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `addcom` channel on [our Discord](discord.vuestorefront.io).
